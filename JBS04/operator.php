...
echo "Hasil Sama dari {$a} Sama dengan {$b} = {$hasilSama}";
var_dump($hasilSama);
echo "<br>";
echo "Hasil Tidak Sama {$a} Tidak Sama dengan {$b} = {$hasilTidakSama}";
var_dump($hasilTidakSama);
echo "<br>";
echo "Hasil Lebih Kecil dari {$a} Lebih Kecil {$b} = {$hasilLebihKecil}";
var_dump($hasilLebihKecil);
echo "<br>";
echo "Hasil Lebih Besar dari {$a} Lebih Besar {$b} = {$hasilLebihBesar}";
var_dump($hasilLebihBesar);
echo "<br>";
echo "Hasil Lebih Kecil Sama dari {$a} Lebih Kecil Sama {$b} = {$hasilLebihKecilSama}";
var_dump($hasilLebihKecilSama);
echo "<br>";
echo "Hasil Lebih Besar Sama dari {$a} Lebih Besar Sama {$b} = {$hasilLebihBesarSama}";
