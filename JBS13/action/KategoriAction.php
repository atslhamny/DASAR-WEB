...
onclick="editData('.$row['kategori_id'].')"><i class="fa fa-edit"></i></button><button class="btn btn-sm btn-danger"
...
if($act=='save') {
    $data=[ 'kategori_kode'=>antiSqlInjection($_POST['kategori_kode']),
